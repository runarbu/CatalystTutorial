...
the C<entry_class> configuration variable.  For example:
    ...
    __PACKAGE__->config(
        # ...
        entry_class => 'MyApp::Model::LDAP::Entry',
    );

    1;

    # In lib/MyApp/Model/LDAP/Entry.pm
    package MyApp::Model::LDAP::Entry;
    use base 'Catalyst::Model::LDAP::Entry';
...
sub update {
    ...
    return $self->SUPER::update($client, @_);
}
