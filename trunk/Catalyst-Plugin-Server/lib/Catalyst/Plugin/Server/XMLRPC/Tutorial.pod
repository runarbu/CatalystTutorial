...
bundled rpc_client.pl script in this distribution

    $ rpc_client.pl -u http://your.host.tld/rpc -m foo
...
A user could now post to your XMLRPC server as follows, with the
bundled rpc_client.pl script in this distribution, to get to the
C<goto_regex> method;

    $ rpc_client.pl -u http://your.host.tld/rpc -m foo.bar 
