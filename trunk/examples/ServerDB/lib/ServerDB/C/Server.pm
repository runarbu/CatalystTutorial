...
sub auto : Private {
	...
	# note: join here is to support server names with forward slashes in them
	...
	# there is some kind of tied hash bug in 5.8.4, so I'm passing these through seperately
