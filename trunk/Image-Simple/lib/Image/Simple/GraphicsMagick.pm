package Image::Simple::GraphicsMagick;
...
sub open {
    ...
    my $adaptee = Graphics::Magick->new;
...
=head1 NAME
    ...
    Image::Simple::GraphicsMagick - Adaptor for Graphics::Magick

=head1 SYNOPSIS

    use Image::Simple;
    
    Image::Simple->adaptor('GraphicsMagick');
